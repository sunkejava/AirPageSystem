...
public static class SeedData
{
    public static async Task InitializeAsync(AppDbContext db, IServiceProvider services, IConfiguration configuration)
    {
        ...
        if (!types.Contains("employee-badge")) db.Templates.Add(new PanelTemplate { Name = "自定义工牌面板", Type = "employee-badge", Description = "支持头像、单位、姓名、职位、编号、部门及联系方式", IsBuiltIn = true, SchemaJson = "{\"preset\":\"badge\",\"company\":\"AIRPAGE SYSTEM\",\"companyEn\":\"IDENTITY CARD\",\"name\":\"张三\",\"nameEn\":\"ZHANG SAN\",\"role\":\"高级工程师\",\"id\":\"AP-0001\",\"department\":\"研发中心\",\"phone\":\"138 0000 0000\",\"email\":\"name@example.com\",\"location\":\"中国 · 上海\",\"message\":\"专业 · 可靠 · 高效\",\"validUntil\":\"长期有效\"}" });
